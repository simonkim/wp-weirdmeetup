...
$of_options[] = array( 	"name" 		=> "Search Bar",
						"desc" 		=> "Enable or disable the heading search bar.",
						"id" 		=> "search_bar",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Site Description",
						"desc" 		=> "Enable or disable the heading site description.",
						"id" 		=> "site_description",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Site Menu",
						"desc" 		=> "Enable or disable the heading site menu.",
						"id" 		=> "site_menu",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Featured Image Switch",
						"id" 		=> "featured_image_blog",
						"desc" 		=> "Enabel or disable featured images from your blog roll page.",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
						"type" 		=> "switch"
...
$of_options[] = array( 	"name" 		=> "Post Excerpt Length (In Words)",
						"desc" 		=> "Set the amount of words you would like to dislay for post excerpts on your blog roll page.",
						"id" 		=> "excerpt_length",
						"std" 		=> "45",
						"min" 		=> "1",
						"step"		=> "1",
...
$of_options[] = array( 	"name" 		=> "Post Page",
						"type" 		=> "heading"
				);


$of_options[] = array( 	"name" 		=> "Featured Image",
						"desc" 		=> "Enabel or disable featured images from your blog post pages",
						"id" 		=> "featured_image",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Tweet This Link",
						"desc" 		=> "Enabel or disable the Tweet This link at the bottom of your blog post pages",
						"id" 		=> "switch_ex1",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Comments Switch",
						"desc" 		=> "Enabel or disable the Show Comments link at the bottom of your blog post pages",
						"id" 		=> "switch_ex2",
						"std" 		=> 1,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
$of_options[] = array( 	"name" 		=> "Footer Widget Section",
						"desc" 		=> "Enabel or disable the Footer Widegets Section.",
...
$of_options[] = array( 	"name" 		=> "Footer Social Buttons",
						"desc" 		=> "Show Facebook Button",
						"id" 		=> "facebook",
						"std" 		=> 1,
						"folds" 	=> 1,
						"type" 		=> "checkbox"
...
$of_options[] = array( 	"name" 		=> "Facebook URL",
						"desc" 		=> "Enter your Facebook URL link here.",
						"id" 		=> "facebook_url",
						"std" 		=> "Type URL here.",
						"fold" 		=> "facebook",
						"type" 		=> "text"
...
$of_options[] = array( 	"name" 		=> "Google+ URL",
						"desc" 		=> "Enter your Google+ URL link here.",
						"id" 		=> "google_url",
						"std" 		=> "Type URL here.",
						"fold" 		=> "google",
						"type" 		=> "text"
...
$of_options[] = array( 	"name" 		=> "Twitter URL",
						"desc" 		=> "Enter your Twitter URL link here.",
						"id" 		=> "twitter_url",
						"std" 		=> "Type URL here.",
						"fold" 		=> "twitter",
						"type" 		=> "text"
...
$of_options[] = array( 	"desc" 		=> "LinkedIn",
						"id" 		=> "linkedin",
						"std" 		=> 1,
						"folds" 	=> 1,
						"type" 		=> "checkbox"
...
$of_options[] = array( 	"name" 		=> "LinkedIn URL",
						"desc" 		=> "Enter your LinkedIn URL link here.",
						"id" 		=> "linkedin_url",
						"std" 		=> "Type URL here.",
						"fold" 		=> "linkedin",
						"type" 		=> "text"
...
$of_options[] = array( 	"name" 		=> "Tracking Options",
						"type" 		=> "heading"
				);

$of_options[] = array( 	"name" 		=> "Header Tracking Code",
						"desc" 		=> "Paste any tracking code that needs to be added to the header of your theme. 
										This will be added into the header template of your theme.",
						"id" 		=> "header_tracking_code",
						"std" 		=> "",
						"type" 		=> "textarea"
				);
...
$of_options[] = array( 	"name" 		=> "Footer Tracking Code",
						"desc" 		=> "Paste your Google Analytics (or other) tracking code here. 
										This will be added into the footer template of your theme.",
...
$of_options[] = array( 	"name" 		=> "Tracking Settings",
						"type" 		=> "heading"
				);
