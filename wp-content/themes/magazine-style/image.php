...
<h1><?php the_title(); ?></h1>
<div class="entry" class="clearfix"><?php if (of_get_option('magazine_ad2') <> "" ) { echo stripslashes(of_get_option('magazine_ad2')); } ?>
<div class="entry-meta">
								<?php
								$metadata = wp_get_attachment_metadata();
								printf( __( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'magazine' ),
...
?>
								...
								$attachment_size = apply_filters( 'magazine_attachment_size', array( 960, 960 ) );
