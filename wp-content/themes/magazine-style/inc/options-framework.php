...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Magazine Style Options', 'optionsframework'),
		'menu_title' => __('Magazine Style Options', 'optionsframework'),
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear','magazine' ),
			'defaultString' => __( 'Default', 'magazine' ),
			'pick' => __( 'Select Color', 'magazine' )
		);
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Magazine Style Options', 'magazine' ),
