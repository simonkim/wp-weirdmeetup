 ...
 * att_comment() which is located at functions/comments-callback.php
 *
 * @package WordPress
...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<h2 class="comments-title heading">
        	<span>
				<?php
                    printf( _nx( 'This article has 1 comment', 'This article has %1$s comments', '', 'comments title', 'att' ),
		...
		<ol class="commentlist">
			<?php wp_list_comments( array( 'callback' => 'att_comment', 'style' => 'ol' ) ); ?>
		</ol><!-- .commentlist -->
		...
		<p class="no-comments"><?php _e( 'Comments are closed.' , 'att' ); ?></p>
		<?php endif; ?>
